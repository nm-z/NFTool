...
export function ControlInput({ label, value, onChange, min, max, step = 1, tooltip }: { label: string, value: string, onChange?: (v: string) => void, min?: number, max?: number, step?: number, tooltip?: string }) {
