        ...
        <div className="flex-1 overflow-hidden">
          ...
          >
            <div className="text-[11px] text-[#52525b] italic">
              No local checkpoints found in workspace/runs/reports
            </div>
          </Tabs.Content>
        </div>
      </Tabs.Root>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            <PlotCard
              ...
              src={`${API_URL}/results/optuna_optimization_history.png`}
            />
            <PlotCard
              title="Parameter Importances"
              src={`${API_URL}/results/optuna_param_importances.png`}
            />
            <PlotCard
              title="Pred vs Actual"
              src={`${API_URL}/results/r2_pred_vs_actual.png`}
            />
            <PlotCard
              title="Error Histogram"
              src={`${API_URL}/results/r2_error_histogram.png`}
            />
          </div>
        </div>
      </div>
